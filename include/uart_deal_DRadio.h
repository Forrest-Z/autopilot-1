//uart_deal_DRadio.h 数字电台
#ifndef __UART_DEAL_DRADIO__H_
#define __UART_DEAL_DRADIO__H_
...
typedef struct{
	...
	uint8	*u16_St_BatteryVoltage		;	//供电电压
	uint8	*u16_St_BatteryCurrent		;	//供电电流
...
extern DRIOP_REV_MSG DrIOP_rev_msg;
extern DRIOP_SEND_MSG DrIOP_send_msg;
extern COMM_SIGN dradio_sign;
extern uint32 TEST_DEST_0;

void *uart_deal_dradio(void *aa);
void DRIOP_sdMsg_Init(void);
extern void DRIOPCommCalInit(void);
extern void initDRIOPsendTask();
void runDRIOPSendMsg(void *);
uint8* DrIOP_Switch_connect(int32 connectNum);


#endif /*__UART_DEAL_DRADIO__H_*/