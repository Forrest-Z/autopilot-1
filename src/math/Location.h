...
public:
    ...
    Location(const Vector3f &ekf_offset_neu,const Location &ekf_origin);
    ...
    bool get_vector_xy_from_origin_NE(Vector2f &vec_ne,const Location &ekf_origin) const WARN_IF_UNUSED;
  ...
  //  bool is_zero() const ;
    ...
    float get_bearing(const struct Location &loc2) const { return math::radians(get_bearing_to(loc2) * 0.01f); } ;
