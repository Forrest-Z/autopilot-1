...
enum ErrorCode {
  ...
  ARM_ERROR = 1000,
  INS_ERROR = 3000,
  INS_ERROR_SP_OPEN_FAILED = 3001,
  INS_ERROR_TIMEOUT = 3002,
  INS_ERROR_LOCATION_INVALID = 3003,
  CAN_ERROR = 5000,
  CAN_ERROR_TIMEOUT = 5001,
  SHIP_STOP_ERROR = 10000,
  SHIP_STOP_XXX_TIMEOUT = 10001
};
bool ErrorCode_IsValid(int value);
const ErrorCode ErrorCode_MIN = OK;
const ErrorCode ErrorCode_MAX = SHIP_STOP_XXX_TIMEOUT;
...
class StatusPb : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:usv.common.StatusPb) */ {
 public:
  StatusPb();
  virtual ~StatusPb();
  ...
  // @@protoc_insertion_point(class_scope:usv.common.StatusPb)
 private:
...
inline ::usv::common::ErrorCode StatusPb::error_code() const {
  // @@protoc_insertion_point(field_get:usv.common.StatusPb.error_code)
  return static_cast< ::usv::common::ErrorCode >(error_code_);
}
inline void StatusPb::set_error_code(::usv::common::ErrorCode value) {
...
template <> struct is_proto_enum< ::usv::common::ErrorCode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::usv::common::ErrorCode>() {
  return ::usv::common::ErrorCode_descriptor();
}
