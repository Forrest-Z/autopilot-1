...
class Header : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:usv.common.Header) */ {
 public:
  Header();
  virtual ~Header();
  ...
  const ::usv::common::StatusPb& status() const;
  ::usv::common::StatusPb* mutable_status();
  ::usv::common::StatusPb* release_status();
  void set_allocated_status(::usv::common::StatusPb* status);
  ...
  // @@protoc_insertion_point(class_scope:usv.common.Header)
 private:
...
inline const ::usv::common::StatusPb& Header::status() const {
...
inline ::usv::common::StatusPb* Header::mutable_status() {
  set_has_status();
  if (status_ == NULL) {
...
inline ::usv::common::StatusPb* Header::release_status() {
...
inline void Header::set_allocated_status(::usv::common::StatusPb* status) {
  delete status_;
  status_ = status;
  if (status) {
    set_has_status();
